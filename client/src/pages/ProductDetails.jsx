        ...
        <div className="border-b flex flex-col md:flex-row items-center mt-10 pb-6">
          ...
          <div className="flex flex-col text-center md:text-left md:ml-6">
            ...
            <div className="flex items-center justify-center md:justify-start mt-3">
              ...
              <div className="ml-2 text-lg font-semibold text-gray-700">
                {rating}/5
              </div>
            </div>
            <div className="mt-3 text-2xl font-bold text-green-500">
        ...
        {reviews.length > 0 ? (
          <div className="mt-10">
            {reviews.map((review, index) => (
              <div
                key={index}
                className="border-b pb-6 mb-6 flex flex-col md:flex-row bg-gray-50 p-4 rounded-lg shadow-sm"
              >
                <div className="md:w-1/4 text-left md:pr-6 mr-2 mb-4 md:mb-0 flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-lg text-gray-900 ml-3">
                      {review.author.name}
                    </div>
