        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="text-lg md:text-xl mb-8">
              Discover the best exercises tailored for all fitness levels. From
              strength training to flexibility, enhance your workout routine
              with our expert-guided plans.
            </p>
            <Link
